...
class EmailMeButtonWidget extends StatelessWidget {
  const EmailMeButtonWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return PortfolioElevatedButton(
      child: Row(
        ...
        children: [
          SvgPicture.asset(ImagePaths.mail,
          ...
          Text(Strings.emailMe, style: TextStyle(color: AppColors.whiteColor,
