...
class ProjectMobileLayout extends StatelessWidget {
  const ProjectMobileLayout({super.key, required this.itemWidth});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SectionTitle(title: Strings.projectTitle,
            fontSize: Dimens.fontSize28, fontWeight: FontWeight.w700,),
          const SizedBox(height: 24),
          SectionDescription(title: Strings.projectDesc,
